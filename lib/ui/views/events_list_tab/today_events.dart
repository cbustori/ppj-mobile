...
class TodayEvents extends StatefulWidget {
  ...
  TodayEvents({this.onRefresh});

  @override
  State<StatefulWidget> createState() => TodayEventsState();
}

class TodayEventsState extends State<TodayEvents> {
  ...
  void _onScroll() {
    ...
    if (maxScroll - currentScroll <= _scrollThreshold) {
      BlocProvider.of<TodayEventsBloc>(context).add(Fetch());
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<TodayEventsBloc, EventsState>(listener:
        (context, state) {
      if (state is EventsError) {
        ...
        BlocBuilder<TodayEventsBloc, EventsState>(builder: (context, state) {
