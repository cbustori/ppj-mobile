...
class SoonEvents extends StatefulWidget {
  final VoidCallback onRefresh;
  SoonEvents({this.onRefresh});

  @override
  State<StatefulWidget> createState() => SoonEventsState();
}

class SoonEventsState extends State<SoonEvents> {
  ...
  void _onScroll() {
    ...
    if (maxScroll - currentScroll <= _scrollThreshold) {
      BlocProvider.of<SoonEventsBloc>(context).add(Fetch());
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<SoonEventsBloc, EventsState>(
      ...
      if (state is EventsError) {
        Scaffold.of(context).showSnackBar(
          SnackBar(
            ...
            BlocBuilder<SoonEventsBloc, EventsState>(builder: (context, state) {
